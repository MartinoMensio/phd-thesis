...
After this overview of each of them, we present some additional related phenomena (Section~\ref{sec:lit_related}).
...
Persuasion is generally defined as a method to \emph{influence a person's beliefs, attitudes, intentions, motivations, or behaviours}~\cite{gass2018persuasion}.
...
\section{\statusorange Related Phenomena}
...
Literature presents propaganda and populism frequently together.
...
Our main observation is that each one of them is like in a silo and not considering the other ones.
...
We also exclude the development or refinement of models that work in one only of the research topics listed above. This work is focused instead on the relationship between these ingredients.
