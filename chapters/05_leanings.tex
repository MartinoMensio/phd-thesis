...
\begin{figure}[!htbp]
    ...
    \caption{Word-based percentage of detected sentiment and propaganda across political leaning.}
...
\subsubsection{Baseline Incomparability} %with the real baseline of~\cite{baly2020we}.
...
\begin{figure}[!tb]
    ...
    \vspace{-20px}
    \caption{An example where a propaganda technique is connected with many surrounding entities.}
    \vspace{-8px}
