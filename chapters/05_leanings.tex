...
Therefore, after introducing the new ingredient of \emph{political leaning} in section~\ref{sec:ps_political_sides} (definition, datasets and methods), we analyse the relationships it has with persuasion.
...
We present in Appendix~\ref{app:nela_processing} the processing of this dataset, to create balanced and unbalanced versions of both random and media splits for it.
...
\subsection{Comparison of the quantity of persuasion across leanings}
...
\subsubsection{Overall Quantity of Propaganda/Sentiment}
...
\subsection{Comparing propaganda-term importance across leaning}
...
One limitation is that only articles from the Right political spectrum were used for training the propaganda detection tool provided in \cite{da2019fine}. %, which we use in our analysis. 
...
\subsubsection{Baseline In/Comparability} %with the real baseline of~\cite{baly2020we}.
...
As shown in experiment 3, some terminologies are common to Left, Right, and Centre articles. In political narrative, many words tend to be used frequently by different political-leaning groups, but for different meanings or to refer to different groups \cite{seargeant2020art}. For example, the word ``Elite'' is used by the Left to refer to people holding economic and political powers, and by the Right to point to those in the cultural and knowledge sector \cite{seargeant2020art}.  
...
\subsubsection{Media Bias/Fact Check propaganda}
...
\subsubsection{In other languages}
...
This discussion, going slightly off the core goals of this thesis, is dealt with Appendix~\ref{app:prop_and_populism}.
