...
\subsection{\statusorange Detected Topics in the Dataset}
...
\paragraph{Potential ways to aggregate and find middle-level topics}
...
chu2019tifi for fictional domain, cleaning up category graph for fictional domains
...
% Wikipedia categories github experiment? https://github.com/wasiahmad/mining\_wikipedia/tree/master/WikiNomy 
\paragraph{A badly structured problem}
...
\paragraph{IPTC Taxonomy}

FreeBase vs TextRazor \todo{check that this refers to IPTC}
...
\subsection{\statusred Topic analysis across political spectrum}
