...
\begin{table}[!htbp]
  ...
  %\small
    ...
    \begin{tabular}{l|rr|rr|rr|rr}
        & \multicolumn{2}{c}{\texttt{NELA-Random-Imbalanced}} & \multicolumn{2}{c}{\texttt{NELA-Random-Balanced}} & \multicolumn{2}{c}{\texttt{NELA-Media-Imbalanced}} & \multicolumn{2}{c}{\texttt{NELA-Media-Balanced}} \\
        Model & F1-Macro & Accuracy & F1-Macro & Accuracy \\
        \hline
        \texttt{Majority} & 21.5632 & 47.8086 & \\
        % \texttt{Baly-API} & 42.3355 & 43.8356 & 42.0523 & 43.6910 & 41.6863 & 41.7993 & & & & \\
        \texttt{Baly-baseline} (0) &  \\
        %\texttt{Baly-paper} (*) & 80.19 & 79.83 & 35.53 & 36.75 \\
        \hline
        \texttt{Prop-Total} (1) &  \\
        \texttt{Prop-Techniques} (2) &  \\
        \texttt{Prop-Total-Terms} (3a) &  \\
        \texttt{Prop-Techniques-Terms} (3b) &  \\
        % \texttt{Prop-words-BERT} (3) & 35.4718 & 48.2387 & 35.4718 & 48.2387 \\
        \hline
        (0) + (1) &  \\
        (0) + (2) &  \\
