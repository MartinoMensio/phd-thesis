...
From this view on the computational detection resources, we recognise a quite strong skew over right-leaning sources that is happening in the English-based datasets. We want to understand if propaganda can be also detected on sources from the left and centre.
...
\todo{continue importing and fixing}
