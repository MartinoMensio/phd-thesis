...
Our goal is to see and understand how persuasion (and more specifically propaganda) varies across the political spectrum.
...
\begin{enumerate}
    ...
    \item relatively large: we need a good number of articles (e.g. $\sim$10k) in order to apply successfully big and powerful models;
...
This implies that in most of the cases, the datasets give a source-based political leaning definition. In other words, that all the articles from a certain news source have the same leaning.
