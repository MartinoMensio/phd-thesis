...
As we already described in the literature chapter~\ref{sec:lit_leaning}, political leaning is a broad concept that generally describes how much someone is positioned between left and right ideologies. This is an oversimplification, and you can find more details in the literature analysis performed there.

The practical definition that we take into consideration is a mono-dimensional feature that varies across an axis that links Left and Right.
...
Having the task of political leaning classification, the practical definition of leaning comes from the datasets that have been used.
...
\end{figure}
\todo{Fig~\ref{fig:prop_tech_details_across_leaning} Would it be better to show also std deviation or other distribution info like in the previous plot?}
...
Then, we also have a conceptual reason. Both political leaning classification and propaganda analysis are types of political analysis.
...
The following subsections first describe the general setup of the experiment, then deal with each one of the three sub-research questions that we listed in the introduction: quantity, quantity by type, terms analysis.% TODO , context.
...
The feature combination $(0) + (2)$ (baseline and quantity of propaganda techniques), when tested for with McNemar test, resulted significant ($p-value=0.008$).
But we still question whether the results, with such a small margin would generalise to other datasets.
...
Table~\ref{TODO} shows the results
...
\begin{table}[!htbp]
  ...
  %\small
    ...
    \begin{tabular}{l|rr|rr|rr|rr}
        ...
        \hline
        \texttt{Majority} & 21.5632 & 47.8086 & 16.6666 & 33.3333 & \\
        % \texttt{Baly-API} & 42.3355 & 43.8356 & 42.0523 & 43.6910 & 41.6863 & 41.7993 & & & & \\
        \texttt{Baly-baseline} (0) & 69.2076 & 71.2211 & 70.9808 & 70.8977 & \\
        %\texttt{Baly-paper} (*) & 80.19 & 79.83 & 35.53 & 36.75 \\
        \hline
        \texttt{Prop-Total} (1) & 21.5632 & 47.8086 & 29.5603 & 35.2938 &  \\
        \texttt{Prop-Techniques} (2) & 25.6280 & 47.8404 & 38.4605 & 39.7791 & \\
        \texttt{Prop-Total-Terms} (3a) & 41.3193 & 49.6682 & 41.8435 & 42.3996 & \\
        \texttt{Prop-Techniques-Terms} (3b) & & & 39.3319 & 41.0597 &  \\
        % \texttt{Prop-words-BERT} (3) & 35.4718 & 48.2387 & 35.4718 & 48.2387 \\
        \hline
        (0) + (1) & & & 70.9899 & 70.9057 &   \\
        (0) + (2) & & & 71.0331 & 70.9510 & \\
        (1) + (2) & & & 38.5816 &  39.8064 &  \\
        (0) + (1) + (2) & & & -69.6198 & -71.8145 & \\
        (0) + (3a) &  \\
        (0) + (3b) &  \\
        (3a) + (3b) &  \\
        (0) + (3a) + (3b) &  \\
...
\paragraph{Total Quantity of Propaganda}
\paragraph{Quantity of Propaganda Techniques}

Result: similar behaviour

\todo{getting results from the server}
