...
\subsection{\statusred Datasets for Political Leaning Prediction}
...
\subsubsection{\statusgreen Baly dataset}
...
\subsubsection{NELA-GT18}

s application of MBFC labels

our work to make it balanced etc
