...
We describe here in the following sections our processing to build an additional second dataset for the political leaning classifier, with random and media splits as the \texttt{Baly} dataset.
...
We provide here both balanced and unbalanced versions of a subset derived from NELA-GT-2018 in two flavors:
