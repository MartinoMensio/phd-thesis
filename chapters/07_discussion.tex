...
\begin{enumerate}
    ...
    \todoAW{This is probably the strongest contribution. Put it first, to emphasise your "significant contribution to knowledge".}
    More specifically:
    \begin{enumerate}
...
\begin{enumerate}
    ...
    \begin{enumerate}
        ...
        \todoAW{Again, put this first so that you draw attention to your main contributions.}
