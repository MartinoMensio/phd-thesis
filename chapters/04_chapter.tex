...
For simplicity, we consider the case where we have 10 headlines (corresponding to the third row of tables~\ref{tab:sentpropnoise_tfidf} and~\ref{tab:sentpropnoise_use}).
...
\begin{table}[!htbp]
    ...
    \label{tab:my_label}
\end{table}
\todo{How to visualise this? Table? Plot?}
