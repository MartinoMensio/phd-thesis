...
This 265 speeches all have a leaning classification (we will see more about leanings in the next chapter)
...
Goals:
Correlation between propaganda and populism on this dataset
Use a more balanced dataset (left-leaning articles)

% results
Correlation between populism (averagerubric column) and propaganda. Spearman’s:
0.169 with total propaganda quantity → generally low
With each technique:
0.0016816375499880873, 'PROPAGANDA:Loaded\_Language'
0.09130843484547149, 'PROPAGANDA:Doubt'
0.22264102520957332, 'PROPAGANDA:Flag-Waving'
0.14597783189491995, 'PROPAGANDA:Name\_Calling/Labeling'
0.05473195042155012, 'PROPAGANDA:Appeal\_to\_fear-prejudice'
0.009004957223912572, 'PROPAGANDA:Exaggeration/Minimisation'
-0.030922623225167634, 'PROPAGANDA:Appeal\_to\_Authority'
0.1144714471745093, 'PROPAGANDA:Reductio\_ad\_hitlerum'
nan, 'PROPAGANDA:Bandwagon'
0.09621605042614789, 'PROPAGANDA:Black-and-White\_Fallacy'
0.10482905539247817, 'PROPAGANDA:Causal\_Oversimplification'
nan, 'PROPAGANDA:Obfuscation/Intentional\_Vagueness/Confusion'
nan, 'PROPAGANDA:Red\_Herring'
-0.06071980052307917, 'PROPAGANDA:Repetition'
0.14586262060219735, 'PROPAGANDA:Slogans'
nan, 'PROPAGANDA:Straw\_Men'
0.04832388032279562, 'PROPAGANDA:Thought-terminating\_Cliches'
0.03393924564812576, 'PROPAGANDA:Whataboutism'
