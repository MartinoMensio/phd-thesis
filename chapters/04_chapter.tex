...
\subsection{Fine-grained Propaganda Analysis}
...
\subsection{Propaganda vs Populism}
...
In this section we analyse the relationship between the proxies just described, and the variations acrosss the articles.
...
\subsection{Removing propaganda/sentiment to make better clustering?}
