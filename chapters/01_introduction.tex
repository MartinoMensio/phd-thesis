...
We give here a short description of the main concepts that are used in this thesis. For a complete list, please refer to the Glossary. We place them at the beginning of the thesis to give a general understanding of the terms used. After the experimental chapters, we are going to refine some of the definitions in the context of the results obtained.
...
% \textbf{Similarity / Variations}: The specific combination of \gls{corroborate}[d] and \gls{omit}[ted] details.%\todoAW{Not a sentence.}
% Terms that change.%\todoAW{Not a sentence.}
% Similarity metrics%\todoAW{So is it the details or the metrics? Again, precision!}
% that score how similar/dissimilar articles are.\todoAW{Not a sentence.}

\textbf{News}: \glsdesc*{news}.
...
Between persuasion and propaganda, we consider the difference to be in the intent. Persuasion is a broader term that includes all the techniques used to convince the reader, while propaganda is a subset of these techniques characterised by the absence of logical reasoning. %Our aim is to see if we are able computationally to observe the difference between
This difference of intent, is difficult to grasp from a stylistic point of view.
We are not interested in this work in distinguishing between propaganda and persuasion, we are only driven by the nature of available resources that aim to analyse the techniques used in news articles.
We will revisit this distinction at the end of this work, accounting for the limitations of the resources used.
