...
\newglossaryentry{news}
{
    name=news,
    description={Information or reports about recent events \footnote{\url{https://dictionary.cambridge.org/dictionary/english/news}}. In this work, our main objective is to analyse multiple news reports from multiple sources to identify which contents (topics) and techniques (persuasion/propaganda) they contain}
}
...
\newglossaryentry{propaganda}
{
    ...
    % . It has many points in common with argumentation/rhetorics and is usually associated with deceiving techniques and partial points of view.
    ...
    %                 How a set of techniques (deceitful, skipping reasoning) is used to persuade the reader.
    %                 }
}
